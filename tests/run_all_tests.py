...
class ComprehensiveTestRunner:
    ...
    def __init__(self):
        ...
        self.results = {"unit_tests": None, "integration_tests": None, "performance_tests": None, "overall": None}
    ...
    def _generate_comprehensive_report(self):
        ...
        for test_key, test_name in test_types:
            ...
            if result:
                ...
                print(
                    f"   {status_icon} {test_name}: {result['passed_tests']}/{result['total_tests']} "
...
def main():
    ...
    parser.add_argument("--mode", choices=["full", "quick", "ci"], default="full", help="테스트 실행 모드")
    parser.add_argument("--no-performance", action="store_true", help="성능 테스트 제외")
