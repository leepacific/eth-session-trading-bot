...
class ParameterManager:
    ...
    def save_current_params(self, params: Dict[str, Any], source: str, 
    ...
    def load_current_params(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                'timestamp': datetime.now().isoformat(),
                'source': 'default',
                'parameters': self.default_optimal_params
            }
    ...
    def get_parameter_comparison(self) -> Dict[str, Any]:
        ...
        for param_name, default_value in self.default_optimal_params.items():
            ...
            comparison['comparison'][param_name] = {
                ...
                'change_percent': ((current_value - default_value) / default_value * 100) 
                                if isinstance(current_value, (int, float)) and default_value != 0 else 0
            }
